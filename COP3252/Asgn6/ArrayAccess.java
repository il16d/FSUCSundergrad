            ...
            public void actionPerformed( ActionEvent e )
            {
               ...
               /* Write catch handlers that catch the two types of exceptions
                ...
                catch (NumberFormatException exception)
                {
                    ...
                    System.out.println("Enter only integer values LINE 69");
                }
                catch (ArrayIndexOutOfBoundsException exception)
                {
                     JOptionPane.showMessageDialog(null, "Array may contain only 10 elemnts.", "Array Full", JOptionPane.ERROR_MESSAGE);
                    System.out.println("Array may contain only 10 elemnts LINE 74");
                }
         ...
         new ActionListener() 
         {
            public void actionPerformed( ActionEvent event ) 
            {
               ...
               /* Write catch handlers that catch the two types of exceptions that
                ...
                {
                     JOptionPane.showMessageDialog(null, "Please enter only integer values.", "Invalid Input", JOptionPane.ERROR_MESSAGE);
                    System.out.println("Enter only integer values LINE 123");
                    //serching the array, this returns the indext where the value is found at
                }
                catch (NumberNotFoundException exception)
                {
                    ...
                    System.out.println("Number not found in Array LINE 129");
                }
         ...
         new ActionListener() 
         {
            public void actionPerformed( ActionEvent event )
            {
               ...
               /* Write catch handlers that catch the two types of exceptions
                ...
                {
                     JOptionPane.showMessageDialog(null, "Enter only integer values.", "Invalid Input", JOptionPane.ERROR_MESSAGE);
                    System.out.println("Enter only integer values LINE 171");
                }
                catch (ArrayIndexOutOfBoundsException exception)
                {
                     JOptionPane.showMessageDialog(null, "Index Not Found.", " Index Out Of Bounds", JOptionPane.ERROR_MESSAGE);
                    System.out.println("Index Not Found LINE 176");
                }
