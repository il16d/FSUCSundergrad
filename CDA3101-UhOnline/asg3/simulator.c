 ...
 * Compile: " gcc -std=c99 simulator.c" *
 * *
******************************************************/
#include <stdio.h>
#include <string.h>
...
int ProcessRType(const unsigned int, int*); //Rtype
int ProcessIType(const int, int*, int*); //Itype

void PrintOper(const int); //Operator
void PrintInstruction(char*); //Instruction
void PrintData(int*); //Data
void PrintRegs(int*); //Registers

const int MAXASSEMBLY = 32768 * 2 + 1; // const int ASSEMBLY = 32768 * 2 + 2; // per write up
const int MAXINSTR = 32768;// const int INSTRUCTION = 32768;
const int MAXINLINE = 9;
const int MAXOUTLINE = 81;
/*
 const char* const instructionnames[] =   from previous project
...
/*
 const char* const registernames[] =   from my previous proj
